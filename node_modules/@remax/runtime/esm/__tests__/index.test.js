...
describe('ali remax render', function () {
        ...
        var Page = /** @class */ (function (_super) {
            ...
            Page.prototype.render = function () {
                ...
                return (React.createElement(View, null,
                    React.createElement(View, null, "1"),
                    show && React.createElement(View, null, "2"),
                    React.createElement(View, null, "3")));
            };
            return Page;
        }(React.Component));
        var container = new Container(p);
    ...
    it('conditional render', function () {
        var Page = /** @class */ (function (_super) {
            ...
            Page.prototype.render = function () {
                var show = this.state.show;
                return (React.createElement(View, null,
                    show && React.createElement(View, null, "1"),
                    React.createElement(View, null, "2")));
            };
            return Page;
        }(React.Component));
        var container = new Container(p);
    ...
    it('update element props', function () {
        var Page = /** @class */ (function (_super) {
            ...
            Page.prototype.render = function () {
                ...
                return (React.createElement(View, null,
                    React.createElement(Input, { className: input.className, style: input.style, disabled: input.disable })));
            };
            return Page;
        }(React.Component));
        var container = new Container(p);
    ...
    it('renders unitless style', function () {
        var Page = function () { return React.createElement(View, { style: { height: 100, flex: 1 } }, "hello"); };
        var container = new Container(p);
        render(React.createElement(Page, null), container);
        expect(container.root).toMatchSnapshot();
    });
...
describe('flatten update', function () {
    ...
    it('pure rerender when props changed', function (done) {
        ...
        var Page = /** @class */ (function (_super) {
            ...
            Page.prototype.render = function () {
                return (React.createElement(View, { style: { width: '32px' } },
    ...
    it('pure rerender when props delete', function (done) {
        ...
        var Page = /** @class */ (function (_super) {
            ...
            Page.prototype.render = function () {
                return (React.createElement(View, { style: { width: '32px' } }, !this.state.value ? React.createElement(Input, null) : React.createElement(Input, { value: this.state.value })));
            };
            return Page;
        }(React.Component));
        var container = new Container(context);
        ...
        function App() {
            return (React.createElement(View, null,
                React.createElement(Suspense, { fallback: React.createElement(Text, { text: "loading" }) },
                    React.createElement(View, { ref: refs[0] },
                        React.createElement(Text, { text: "A" })),
                    React.createElement(View, { ref: refs[1] },
                        React.createElement(AsyncText, { resource: createTextResource(1, 'B'), text: "B" })),
                    React.createElement(View, { ref: refs[2], style: { display: 'inline' } },
