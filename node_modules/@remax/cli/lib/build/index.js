...
exports.buildMiniComponent = exports.buildMiniPlugin = exports.internalBuildApp = exports.buildApp = exports.run = void 0;
...
function internalBuildApp(options, api) {
    ...
    output_1.default.level = loglevel;
    process.env.REMAX_PLATFORM = target;
    output_1.default.message('🚀 构建应用', 'blue');
...
function buildMiniPlugin(options) {
    ...
    output_1.default.level = loglevel;
    process.env.REMAX_PLATFORM = target;
    output_1.default.message(`🔨 构建插件`, 'blue');
    output_1.default.message(`\n⌨️  remax v${version}\n`, 'green');
    const api = new API_1.default();
    api.registerPlugins([]);
...
function buildMiniComponent(options) {
    process.env.NODE_ENV = process.env.NODE_ENV || 'development';
    const { target, loglevel = 'verbose' } = options;
    output_1.default.level = loglevel;
    process.env.REMAX_PLATFORM = target;
    output_1.default.message(`🔨 构建组件`, 'blue');
    output_1.default.message(`\n⌨️  remax v${version}\n`, 'green');
    const api = new API_1.default();
    api.registerPlugins([]);
...
exports.buildMiniComponent = buildMiniComponent;
